...
use Modules\CatalogueModule\Classes\Factories\VariantProductsFactory;//Helps using the classes from Factories Package
use Modules\CatalogueModule\Entities\VariantProduct;
...
class VariantProductsController extends Controller
{
    ...
    public function create()
    {
        ...
        $Product = new VariantProductsFactory();
        $variantProduct = $Product->CreateProduct($data);
